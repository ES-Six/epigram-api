define({ "api": [
  ...
  {
    "type": "get",
    "url": "/api/v1/user/photos",
    "title": "Get photos of current user",
    "name": "GetuserPhotos",
    "group": "User",
    "version": "1.0.0",
    "header": {
  ...
  },
  {
    "type": "patch",
    "url": "/api/v1/user",
    "title": "Update user profile fields",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "adress",
            "description": "<p>The user adress</p>"
          },
          {
            "group": "Parameter",
            "type": "city",
          ...
          },
          {
            ...
            "optional": false,
            "field": "zip",
            "description": "<p>The user zip code</p>"
          },
          {
            "group": "Parameter",
            "type": "country",
            "optional": false,
            "field": "country",
            "description": "<p>The user country</p>"
          }
        ]
      }
    },
